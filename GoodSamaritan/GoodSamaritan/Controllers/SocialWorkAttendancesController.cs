...
namespace GoodSamaritan.Controllers
{
    public class SocialWorkAttendancesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SocialWorkAttendanceId,SocialWorkAttendanceValue")] SocialWorkAttendance socialWorkAttendance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SocialWorkAttendanceId,SocialWorkAttendanceValue")] SocialWorkAttendance socialWorkAttendance)
        {
            if (ModelState.IsValid)
            {
