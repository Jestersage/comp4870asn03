...
namespace GoodSamaritan.Controllers
{
    public class EthnicitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EthnicityId,Ethnictiy")] Ethnicity ethnicity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EthnicityId,Ethnictiy")] Ethnicity ethnicity)
        {
            if (ModelState.IsValid)
            {
