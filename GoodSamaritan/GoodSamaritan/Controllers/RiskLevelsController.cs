...
namespace GoodSamaritan.Controllers
{
    public class RiskLevelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RiskLevelId,RiskLevelValue")] RiskLevel riskLevel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RiskLevelId,RiskLevelValue")] RiskLevel riskLevel)
        {
            if (ModelState.IsValid)
            {
