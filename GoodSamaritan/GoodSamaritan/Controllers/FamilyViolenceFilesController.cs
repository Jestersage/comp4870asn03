...
namespace GoodSamaritan.Controllers
{
    public class FamilyViolenceFilesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FamilyViolenceFileId,Status")] FamilyViolenceFile familyViolenceFile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FamilyViolenceFileId,Status")] FamilyViolenceFile familyViolenceFile)
        {
            if (ModelState.IsValid)
            {
