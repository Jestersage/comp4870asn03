...
namespace GoodSamaritan.Controllers
{
    public class PoliceReportedsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PoliceReportedId,PoliceReportedValue")] PoliceReported policeReported)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PoliceReportedId,PoliceReportedValue")] PoliceReported policeReported)
        {
            if (ModelState.IsValid)
            {
