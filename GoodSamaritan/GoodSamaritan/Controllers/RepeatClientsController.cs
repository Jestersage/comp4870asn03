...
namespace GoodSamaritan.Controllers
{
    public class RepeatClientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RepeatClientId,Repeat")] RepeatClient repeatClient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RepeatClientId,Repeat")] RepeatClient repeatClient)
        {
            if (ModelState.IsValid)
            {
