...
namespace GoodSamaritan.Controllers
{
    public class VictimServicesAttendancesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VictimServicesAttendanceId,VictimServicesAttendanceValue")] VictimServicesAttendance victimServicesAttendance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VictimServicesAttendanceId,VictimServicesAttendanceValue")] VictimServicesAttendance victimServicesAttendance)
        {
            if (ModelState.IsValid)
            {
