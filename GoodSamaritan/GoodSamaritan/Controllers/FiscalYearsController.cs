...
namespace GoodSamaritan.Controllers
{
    public class FiscalYearsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FiscalYearId,FiscalYearName")] FiscalYear fiscalYear)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FiscalYearId,FiscalYearName")] FiscalYear fiscalYear)
        {
            if (ModelState.IsValid)
            {
